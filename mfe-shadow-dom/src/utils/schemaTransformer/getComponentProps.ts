...
export function getComponentPropValue<Props>(value: string, schema: PropSchema<Props>) {
...
export function getComponentProps<Props = object>(params: GetComponentPropsParams<Props>) {
   ...
   for(const attribute of attributes) {
      ...
      (props as any)[propKey] = getComponentPropValue<Props>(attribute.value, attribute.schema)
   }
